...
<head>
    ...
    <meta content="Themes-design" name="author" />
    <!-- App favicon -->
                ...
                <div class="text-center mt-4">
                    <div class="mb-3">
                        <a href="index.html" class="auth-logo">
                            <img src="{{asset('logo/elangg.png')}}" width="100px" class="logo-dark mx-auto" alt="">
                            <img src="{{asset('logo/elangg.png')}}" width="100px" class="logo-light mx-auto" alt="">
                        </a>
                    </div>
                </div>
